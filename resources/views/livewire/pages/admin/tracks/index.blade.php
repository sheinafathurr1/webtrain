...
<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @php $canReorder = ! $tracks->hasPages() && ! $hasActiveFilters && $tracks->isNotEmpty(); @endphp

            @if ($reordering)
                <div
                    x-data="{
                        items: @js($tracks->map(fn ($t) => ['id' => $t->id, 'title' => $t->title, 'subtitle' => $t->slug])->values()->all()),
                        dragIndex: null,
                    }"
